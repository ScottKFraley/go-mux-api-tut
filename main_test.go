...
import (
	...
	main "github.com/ScottKFraley/go-mux-api-tut"
)
...
func TestMain(m *testing.M) {
	...
	// TODO: (?) Maybe these should be "TEST_*"
	os.Setenv("APP_DB_USERNAME", "skf")
	os.Setenv("APP_DB_PASSWORD", "skfP4ssw0rd")
	os.Setenv("APP_DB_NAME", "postgres")

	defer os.Unsetenv("APP_DB_USERNAME")
